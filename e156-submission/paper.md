...
Paper: EvidenceCrate - Packaging the C Drive Research Portfolio as a Static Metadata Crate
...
Code: repository root, scripts/build_evidence_crate.py, and data-source/portfolio-data.snapshot.json
Date: 2026-03-29
Validation: PASS
